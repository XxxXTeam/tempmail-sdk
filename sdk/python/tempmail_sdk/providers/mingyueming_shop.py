"""
mailmomy 域名变体渠道：mingyueming.shop
固定使用域名 mingyueming.shop 生成邮箱，收信复用 mailmomy 的 get_emails。
"""
...
DOMAIN = "mingyueming.shop"


def generate_email() -> EmailInfo:
    """生成 mingyueming.shop 域名的临时邮箱；Token 即邮箱地址本身"""
