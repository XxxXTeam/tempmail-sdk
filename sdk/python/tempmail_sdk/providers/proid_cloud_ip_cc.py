"""
mailmomy 域名变体渠道：proid.cloud-ip.cc
固定使用域名 proid.cloud-ip.cc 生成邮箱，收信复用 mailmomy 的 get_emails。
"""
...
DOMAIN = "proid.cloud-ip.cc"


def generate_email() -> EmailInfo:
    """生成 proid.cloud-ip.cc 域名的临时邮箱；Token 即邮箱地址本身"""
