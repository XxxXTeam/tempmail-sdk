"""
mailmomy 域名变体渠道：mingyueming.click
固定使用域名 mingyueming.click 生成邮箱，收信复用 mailmomy 的 get_emails。
"""
...
DOMAIN = "mingyueming.click"


def generate_email() -> EmailInfo:
    """生成 mingyueming.click 域名的临时邮箱；Token 即邮箱地址本身"""
