 ...
 * 每个渠道对应一个第三方临时邮箱服务商
 */
export type Channel = 'tempmail' | 'linshi-email' | 'tempmail-lol' | 'chatgpt-org-uk' | 'tempmail-la' | 'temp-mail-io' | 'awamail' | 'mail-tm' | 'dropmail' | 'guerrillamail' | 'maildrop' | 'mail-gw' | 'emailnator' | 'mail-cx';
