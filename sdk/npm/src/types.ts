 ...
 * 每个渠道对应一个第三方临时邮箱服务商
 */
export type Channel = 'tempmail' | 'linshi-email' | 'mffac' | 'tempmail-lol' | 'chatgpt-org-uk' | 'temp-mail-io' | 'awamail' | 'mail-tm' | 'dropmail' | 'guerrillamail' | 'maildrop' | 'smail-pw' | 'boomlify' | 'minmail' | 'vip-215';
