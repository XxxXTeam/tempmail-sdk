...
const channelInfoMap: Record<Channel, ChannelInfo> = {
  ...
  mailmomy: { channel: "mailmomy", name: "Mailmomy", website: "mailmomy.com" },
  "chammy-info": {
    channel: "chammy-info",
  ...
  "mail-td": { channel: "mail-td", name: "Mail.td", website: "mail.td" },
  "mailhole-de": {
    channel: "mailhole-de",
    name: "Mailhole.de",
    website: "mailhole.de",
  ...
  nimail: { channel: "nimail", name: "NiMail", website: "nimail.cn" },
  freecustom: {
    channel: "freecustom",
